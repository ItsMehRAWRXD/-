...
//   11500–11599 Feature modules (telemetry export, composer, LSP features — handleFeaturesCommand)
//   12200–12314 Tier 5 cosmetics (line endings, panels, crash/IRC — handleTier5Command; MUST NOT overlap 11500–11599)
//   11700–11799 Tier 2 cosmetics (git diff, terminal tabs, hover, outline, refs, CodeLens, inlay)
...
// ---- HexMag commands (4121–4125) -------------------------------------------
#define IDM_AGENT_HEXMAG_START 4121
#define IDM_AGENT_HEXMAG_TOGGLE_FALLBACK 4122
#define IDM_AGENT_HEXMAG_ROUTE_COPILOT 4123
#define IDM_AGENT_HEXMAG_HEALTH_CHECK 4124
#define IDM_AGENT_HEXMAG_STOP 4125
...
#define IDM_INFERENCE_SPECULATIVE_RELOAD 4324
...
// ---- Editor tool integration commands (5880–5894) ---------------------------
#define IDM_EDITOR_GOTO_LINE 5880
#define IDM_EDITOR_GOTO_SYMBOL 5881
#define IDM_EDITOR_GOTO_WORKSPACE_SYMBOL 5882
#define IDM_EDITOR_PEEK_DEFINITION 5883
#define IDM_EDITOR_PEEK_REFERENCES 5884
#define IDM_EDITOR_FORMAT_SELECTION 5885
#define IDM_EDITOR_GOTO_IMPLEMENTATION 5886
#define IDM_EDITOR_GOTO_TYPE_DEFINITION 5887
#define IDM_EDITOR_TOGGLE_COMMENT 5888
#define IDM_EDITOR_DUPLICATE_LINE 5889
#define IDM_EDITOR_DELETE_LINE 5890
#define IDM_EDITOR_MOVE_LINE_UP 5891
#define IDM_EDITOR_MOVE_LINE_DOWN 5892
#define IDM_EDITOR_SHOW_INLAY_HINTS 5893
#define IDM_EDITOR_CODE_ACTIONS 5894
