...
bool Win32IDE::routeCommand(int commandId)
{
    ...
    {
        // Phase Ω: OmegaOrchestrator — Autonomous SDLC Pipeline (disabled via FeatureRegistry)
        appendToOutput("[OmegaOrchestrator] Feature disabled. Enable via FeatureRegistry to use autonomous SDLC pipeline.\n", "Output", OutputSeverity::Info);
        return true;
    }
