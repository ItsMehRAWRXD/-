...
// Custom messages for cross-thread UI updates (pipeline runs in worker thread)
#define WM_DIG_PROGRESS    (WM_APP + 100)
#define WM_DIG_FILE        (WM_APP + 101)
#define WM_DIG_FINISHED    (WM_APP + 102)
