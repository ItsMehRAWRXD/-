...
#define COMMAND_TABLE(X)                                                                                               \
    ...
    X(1032, FILE_MODEL_OLLAMA, "file.modelFromOllama", "!model_ollama", BOTH, "File", handleFileModelFromOllama,       \
      CMD_NONE)                                                                                                        \
    ...
    X(2013, EDIT_COPY_FORMAT, "edit.copyFormat", "!copy_format", BOTH, "Edit", handleEditCopyFormat,                   \
      CMD_REQUIRES_SELECT)                                                                                             \
    X(2014, EDIT_PASTE_PLAIN, "edit.pastePlain", "!paste_plain", BOTH, "Edit", handleEditPastePlain,                   \
      CMD_REQUIRES_FILE)                                                                                               \
    X(2015, EDIT_CLIPBOARD_HIST, "edit.clipboardHistory", "!clipboard", BOTH, "Edit", handleEditClipboardHist,         \
      CMD_NONE)                                                                                                        \
    ...
    X(2024, VIEW_FLOATING_PANEL, "view.floatingPanel", "!float_panel", BOTH, "View", handleViewFloatingPanel,          \
      CMD_NONE)                                                                                                        \
    X(2025, VIEW_OUTPUT_PANEL, "view.outputPanel", "!output", BOTH, "View", handleViewOutputPanel, CMD_NONE)           \
    X(2026, VIEW_STREAMING_LOADER, "view.streamingLoader", "!streaming", BOTH, "View", handleViewStreamingLoader,      \
      CMD_NONE)                                                                                                        \
    ...
    X(4008, TERMINAL_SPLIT_V, "terminal.splitV", "!terminal_split_v", BOTH, "Terminal", handleTerminalSplitV,          \
      CMD_NONE)                                                                                                        \
    X(4009, TERMINAL_SPLIT_CODE, "terminal.splitCode", "!terminal_code", BOTH, "Terminal", handleTerminalSplitCode,    \
      CMD_NONE)                                                                                                        \
    ...
    X(4107, AGENT_MEMORY_VIEW, "agent.memoryView", "!agent_memory_view", BOTH, "Agent", handleAgentMemoryView,         \
      CMD_NONE)                                                                                                        \
    X(4108, AGENT_MEMORY_CLEAR, "agent.memoryClear", "!agent_memory_clear", BOTH, "Agent", handleAgentMemoryClear,     \
      CMD_CONFIRM)                                                                                                     \
    X(4109, AGENT_MEMORY_EXPORT, "agent.memoryExport", "!agent_memory_export", BOTH, "Agent", handleAgentMemoryExport, \
      CMD_NONE)                                                                                                        \
    ...
    X(4113, SUBAGENT_TODO_CLEAR, "subagent.todoClear", "!todo_clear", BOTH, "SubAgent", handleSubAgentTodoClear,       \
      CMD_CONFIRM)                                                                                                     \
    X(4114, SUBAGENT_STATUS, "subagent.status", "!agents", BOTH, "SubAgent", handleSubAgentStatus, CMD_NONE)           \
    X(4120, AGENT_BOUNDED_LOOP, "agent.boundedLoop", "!agent_bounded", BOTH, "Agent", handleAgentBoundedLoop,          \
      CMD_ASYNC)                                                                                                       \
                                                                                                                       \
    /* ═══════════════════ AUTONOMY (4150-4155) ═══════════════════ */                                                 \
    ...
    X(4300, REVENG_ANALYZE, "re.analyze", "!decision_tree", BOTH, "ReverseEng", handleREDecisionTree,                  \
      CMD_REQUIRES_FILE)                                                                                               \
    ...
    X(4305, REVENG_DETECT_VULNS, "re.detectVulns", "!re_vulns", BOTH, "ReverseEng", handleREDetectVulns,               \
    ...
    X(4307, REVENG_EXPORT_GHIDRA, "re.exportGhidra", "!re_ghidra", BOTH, "ReverseEng", handleREExportGhidra,           \
      CMD_REQUIRES_FILE)                                                                                               \
    ...
    X(4311, REVENG_SSA, "re.ssaLift", "!ssa_lift", BOTH, "ReverseEng", handleRESSALift,                                \
      CMD_REQUIRES_FILE | CMD_ASM_HOTPATH)                                                                             \
    X(4312, REVENG_RECURSIVE, "re.recursiveDisasm", "!re_recursive", BOTH, "ReverseEng", handleRERecursiveDisasm,      \
      CMD_REQUIRES_FILE | CMD_ASYNC)                                                                                   \
    X(4313, REVENG_TYPE_RECOVERY, "re.typeRecovery", "!re_types", BOTH, "ReverseEng", handleRETypeRecovery,            \
      CMD_REQUIRES_FILE | CMD_ASYNC)                                                                                   \
    X(4314, REVENG_DATA_FLOW, "re.dataFlow", "!re_dataflow", BOTH, "ReverseEng", handleREDataFlow, CMD_REQUIRES_FILE)  \
    X(4315, REVENG_LICENSE_INFO, "re.licenseInfo", "!re_license", BOTH, "ReverseEng", handleRELicenseInfo,             \
      CMD_REQUIRES_FILE)                                                                                               \
    X(4316, REVENG_DECOMPILER, "re.decompilerView", "!decompile", BOTH, "ReverseEng", handleREDecompilerView,          \
      CMD_REQUIRES_FILE)                                                                                               \
    X(4317, REVENG_DECOMP_RENAME, "re.decompRename", "!decomp_rename", BOTH, "ReverseEng", handleREDecompRename,       \
      CMD_REQUIRES_FILE | CMD_REQUIRES_CARET)                                                                          \
    X(4318, REVENG_DECOMP_SYNC, "re.decompSync", "!decomp_sync", BOTH, "ReverseEng", handleREDecompSync,               \
      CMD_REQUIRES_FILE)                                                                                               \
    ...
    X(5037, BACKEND_LOCAL, "backend.switchLocal", "!backend local", BOTH, "Backend", handleBackendSwitchLocal,         \
      CMD_NONE)                                                                                                        \
    X(5038, BACKEND_OLLAMA, "backend.switchOllama", "!backend ollama", BOTH, "Backend", handleBackendSwitchOllama,     \
      CMD_NONE)                                                                                                        \
    X(5039, BACKEND_OPENAI, "backend.switchOpenAI", "!backend openai", BOTH, "Backend", handleBackendSwitchOpenAI,     \
      CMD_REQUIRES_NET)                                                                                                \
    X(5040, BACKEND_CLAUDE, "backend.switchClaude", "!backend claude", BOTH, "Backend", handleBackendSwitchClaude,     \
      CMD_REQUIRES_NET)                                                                                                \
    X(5041, BACKEND_GEMINI, "backend.switchGemini", "!backend gemini", BOTH, "Backend", handleBackendSwitchGemini,     \
      CMD_REQUIRES_NET)                                                                                                \
    ...
    X(5082, ASM_PARSE_SYMBOLS, "asm.parseSymbols", "!asm parse", BOTH, "ASM", handleAsmParse,                          \
      CMD_REQUIRES_FILE | CMD_ASM_HOTPATH)                                                                             \
    X(5083, ASM_GOTO_LABEL, "asm.gotoLabel", "!asm goto", BOTH, "ASM", handleAsmGoto,                                  \
      CMD_REQUIRES_FILE | CMD_REQUIRES_CARET)                                                                          \
    X(5084, ASM_FIND_LABEL_REFS, "asm.findLabelRefs", "!asm refs", BOTH, "ASM", handleAsmFindRefs,                     \
      CMD_REQUIRES_FILE | CMD_REQUIRES_CARET)                                                                          \
    X(5085, ASM_SYMBOL_TABLE, "asm.symbolTable", "!asm symbols", BOTH, "ASM", handleAsmSymbolTable, CMD_REQUIRES_FILE) \
    X(5086, ASM_INSTRUCTION_INFO, "asm.instructionInfo", "!asm info", BOTH, "ASM", handleAsmInstructionInfo,           \
      CMD_REQUIRES_FILE | CMD_REQUIRES_CARET)                                                                          \
    X(5087, ASM_REGISTER_INFO, "asm.registerInfo", "!asm reg", BOTH, "ASM", handleAsmRegisterInfo,                     \
      CMD_REQUIRES_FILE | CMD_REQUIRES_CARET)                                                                          \
    X(5088, ASM_ANALYZE_BLOCK, "asm.analyzeBlock", "!asm block", BOTH, "ASM", handleAsmAnalyzeBlock,                   \
      CMD_REQUIRES_FILE | CMD_REQUIRES_CARET)                                                                          \
    X(5089, ASM_CALL_GRAPH, "asm.callGraph", "!asm callgraph", BOTH, "ASM", handleAsmCallGraph,                        \
      CMD_REQUIRES_FILE | CMD_ASYNC)                                                                                   \
    X(5090, ASM_DATA_FLOW, "asm.dataFlow", "!asm dataflow", BOTH, "ASM", handleAsmDataFlow,                            \
      CMD_REQUIRES_FILE | CMD_ASYNC)                                                                                   \
    X(5091, ASM_DETECT_CONVENTION, "asm.detectConvention", "!asm convention", BOTH, "ASM", handleAsmDetectConvention,  \
      CMD_REQUIRES_FILE)                                                                                               \
    ...
    X(5094, HYBRID_COMPLETE, "hybrid.complete", "!hybrid complete", BOTH, "Hybrid", handleHybridComplete,              \
      CMD_REQUIRES_CARET | CMD_REQUIRES_LSP)                                                                           \
    X(5095, HYBRID_DIAGNOSTICS, "hybrid.diagnostics", "!hybrid diag", BOTH, "Hybrid", handleHybridDiagnostics,         \
      CMD_REQUIRES_LSP)                                                                                                \
    X(5096, HYBRID_SMART_RENAME, "hybrid.smartRename", "!hybrid rename", BOTH, "Hybrid", handleHybridSmartRename,      \
      CMD_REQUIRES_CARET | CMD_REQUIRES_LSP)                                                                           \
    X(5097, HYBRID_ANALYZE_FILE, "hybrid.analyzeFile", "!hybrid analyze", BOTH, "Hybrid", handleHybridAnalyzeFile,     \
      CMD_REQUIRES_FILE | CMD_ASYNC)                                                                                   \
    X(5098, HYBRID_AUTO_PROFILE, "hybrid.autoProfile", "!hybrid profile", BOTH, "Hybrid", handleHybridAutoProfile,     \
      CMD_REQUIRES_FILE | CMD_REQUIRES_DEBUG)                                                                          \
    X(5099, HYBRID_STATUS, "hybrid.status", "!hybrid status", BOTH, "Hybrid", handleHybridStatus, CMD_NONE)            \
    X(5100, HYBRID_SYMBOL_USAGE, "hybrid.symbolUsage", "!hybrid usage", BOTH, "Hybrid", handleHybridSymbolUsage,       \
      CMD_REQUIRES_CARET | CMD_REQUIRES_LSP)                                                                           \
    X(5101, HYBRID_EXPLAIN_SYMBOL, "hybrid.explainSymbol", "!hybrid explain", BOTH, "Hybrid",                          \
      handleHybridExplainSymbol, CMD_REQUIRES_CARET)                                                                   \
    X(5102, HYBRID_ANNOTATE_DIAG, "hybrid.annotateDiag", "!hybrid annotate", BOTH, "Hybrid", handleHybridAnnotateDiag, \
      CMD_REQUIRES_LSP)                                                                                                \
    X(5103, HYBRID_STREAM_ANALYZE, "hybrid.streamAnalyze", "!hybrid stream", BOTH, "Hybrid",                           \
      handleHybridStreamAnalyze, CMD_ASYNC)                                                                            \
    X(5104, HYBRID_SEM_PREFETCH, "hybrid.semanticPrefetch", "!hybrid prefetch", BOTH, "Hybrid",                        \
      handleHybridSemanticPrefetch, CMD_ASYNC)                                                                         \
    X(5105, HYBRID_CORRECTION_LOOP, "hybrid.correctionLoop", "!hybrid correct", BOTH, "Hybrid",                        \
      handleHybridCorrectionLoop, CMD_ASYNC)                                                                           \
                                                                                                                       \
    /* ═══════════════════ MULTI-RESPONSE (5106-5117) ═══════════════════ */                                           \
    X(5106, MULTI_GENERATE, "multi.generate", "!multi generate", BOTH, "MultiResp", handleMultiRespGenerate,           \
      CMD_ASYNC)                                                                                                       \
    X(5107, MULTI_SET_MAX, "multi.setMax", "!multi setmax", BOTH, "MultiResp", handleMultiRespSetMax, CMD_NONE)        \
    X(5108, MULTI_SELECT_PREF, "multi.selectPreferred", "!multi select", BOTH, "MultiResp",                            \
      handleMultiRespSelectPreferred, CMD_NONE)                                                                        \
    ...
    X(5111, MULTI_TEMPLATES, "multi.templates", "!multi templates", BOTH, "MultiResp", handleMultiRespShowTemplates,   \
      CMD_NONE)                                                                                                        \
    X(5112, MULTI_TOGGLE_TMPL, "multi.toggleTemplate", "!multi toggle", BOTH, "MultiResp",                             \
      handleMultiRespToggleTemplate, CMD_NONE)                                                                         \
    ...
    X(5116, MULTI_CLEAR_HIST, "multi.clearHistory", "!multi clear", BOTH, "MultiResp", handleMultiRespClearHistory,    \
      CMD_CONFIRM)                                                                                                     \
    X(5117, MULTI_APPLY_PREF, "multi.applyPreferred", "!multi apply", BOTH, "MultiResp",                               \
      handleMultiRespApplyPreferred, CMD_NONE)                                                                         \
                                                                                                                       \
    /* ═══════════════════ GOVERNOR (5118-5121) ═══════════════════ */                                                 \
    ...
    X(5123, SAFETY_RESET_BUDGET, "safety.resetBudget", "!safety reset", BOTH, "Safety", handleSafetyResetBudget,       \
      CMD_CONFIRM)                                                                                                     \
    X(5124, SAFETY_ROLLBACK, "safety.rollback", "!safety rollback", BOTH, "Safety", handleSafetyRollbackLast,          \
      CMD_CONFIRM)                                                                                                     \
    X(5125, SAFETY_VIOLATIONS, "safety.violations", "!safety violations", BOTH, "Safety", handleSafetyShowViolations,  \
      CMD_NONE)                                                                                                        \
                                                                                                                       \
    /* ═══════════════════ REPLAY (5126-5129) ═══════════════════ */                                                   \
    ...
    X(5129, REPLAY_CHECKPOINT, "replay.checkpoint", "!replay checkpoint", BOTH, "Replay", handleReplayCheckpoint,      \
      CMD_NONE)                                                                                                        \
                                                                                                                       \
    /* ═══════════════════ CONFIDENCE (5130-5131) ═══════════════════ */                                               \
    X(5130, CONFIDENCE_STATUS, "confidence.status", "!confidence status", BOTH, "Confidence", handleConfidenceStatus,  \
      CMD_NONE)                                                                                                        \
    X(5131, CONFIDENCE_POLICY, "confidence.setPolicy", "!confidence policy", BOTH, "Confidence",                       \
      handleConfidenceSetPolicy, CMD_NONE)                                                                             \
                                                                                                                       \
    /* ═══════════════════ SWARM (5132-5156) ═══════════════════ */                                                    \
    ...
    X(5140, SWARM_BLACKLIST, "swarm.blacklistNode", "!swarm blacklist", BOTH, "Swarm", handleSwarmBlacklist,           \
      CMD_CONFIRM)                                                                                                     \
    X(5141, SWARM_BUILD_SOURCES, "swarm.buildSources", "!swarm build_src", BOTH, "Swarm", handleSwarmBuildSources,     \
      CMD_ASYNC)                                                                                                       \
    ...
    X(5146, SWARM_CACHE_CLEAR, "swarm.cacheClear", "!swarm cache_clear", BOTH, "Swarm", handleSwarmCacheClear,         \
      CMD_CONFIRM)                                                                                                     \
    ...
    X(5153, SWARM_WORKER_STATUS, "swarm.workerStatus", "!swarm wstatus", BOTH, "Swarm", handleSwarmWorkerStatus,       \
      CMD_NONE)                                                                                                        \
    X(5154, SWARM_WORKER_CONNECT, "swarm.workerConnect", "!swarm wconnect", BOTH, "Swarm", handleSwarmWorkerConnect,   \
      CMD_ASYNC)                                                                                                       \
    X(5155, SWARM_WORKER_DISCONNECT, "swarm.workerDisconnect", "!swarm wdisconnect", BOTH, "Swarm",                    \
      handleSwarmWorkerDisconnect, CMD_NONE)                                                                           \
    ...
    X(5179, DBG_SWITCH_THREAD, "dbg.switchThread", "!dbg thread", BOTH, "Debug", handleDbgSwitchThread,                \
      CMD_REQUIRES_DEBUG)                                                                                              \
    X(5180, DBG_EVALUATE, "dbg.evaluate", "!dbg eval", BOTH, "Debug", handleDbgEvaluate, CMD_REQUIRES_DEBUG)           \
    X(5181, DBG_SET_REGISTER, "dbg.setRegister", "!dbg setreg", BOTH, "Debug", handleDbgSetRegister,                   \
      CMD_REQUIRES_DEBUG)                                                                                              \
    X(5182, DBG_SEARCH_MEMORY, "dbg.searchMemory", "!dbg search", BOTH, "Debug", handleDbgSearchMemory,                \
      CMD_REQUIRES_DEBUG | CMD_ASYNC)                                                                                  \
    ...
    X(5203, PLUGIN_UNLOAD_ALL, "plugin.unloadAll", "!plugin unload_all", BOTH, "Plugin", handlePluginUnloadAll,        \
      CMD_CONFIRM)                                                                                                     \
    ...
    X(5207, PLUGIN_HOTLOAD, "plugin.toggleHotload", "!plugin hotload", BOTH, "Plugin", handlePluginToggleHotload,      \
      CMD_NONE)                                                                                                        \
    ...
    X(9002, HOTPATCH_MEM_APPLY, "hotpatch.memApply", "!hotpatch_mem", BOTH, "Hotpatch", handleHotpatchMemory,          \
      CMD_ASM_HOTPATH)                                                                                                 \
    X(9003, HOTPATCH_MEM_REVERT, "hotpatch.memRevert", "!hotpatch_revert", BOTH, "Hotpatch", handleHotpatchMemRevert,  \
      CMD_ASM_HOTPATH)                                                                                                 \
    X(9004, HOTPATCH_BYTE_APPLY, "hotpatch.byteApply", "!hotpatch_byte", BOTH, "Hotpatch", handleHotpatchByte,         \
      CMD_ASM_HOTPATH)                                                                                                 \
    X(9005, HOTPATCH_BYTE_SEARCH, "hotpatch.byteSearch", "!hotpatch_search", BOTH, "Hotpatch",                         \
      handleHotpatchByteSearch, CMD_REQUIRES_FILE | CMD_ASM_HOTPATH)                                                   \
    X(9006, HOTPATCH_SRV_ADD, "hotpatch.serverAdd", "!hotpatch_server", BOTH, "Hotpatch", handleHotpatchServer,        \
      CMD_NONE)                                                                                                        \
    X(9007, HOTPATCH_SRV_REMOVE, "hotpatch.serverRemove", "!hotpatch_srv_rm", BOTH, "Hotpatch",                        \
      handleHotpatchServerRemove, CMD_NONE)                                                                            \
    X(9008, HOTPATCH_PROXY_BIAS, "hotpatch.proxyBias", "!hotpatch_bias", BOTH, "Hotpatch", handleHotpatchProxyBias,    \
      CMD_NONE)                                                                                                        \
    X(9009, HOTPATCH_PROXY_REWRITE, "hotpatch.proxyRewrite", "!hotpatch_rewrite", BOTH, "Hotpatch",                    \
      handleHotpatchProxyRewrite, CMD_NONE)                                                                            \
    X(9010, HOTPATCH_PROXY_TERM, "hotpatch.proxyTerminate", "!hotpatch_term", BOTH, "Hotpatch",                        \
      handleHotpatchProxyTerminate, CMD_NONE)                                                                          \
    X(9011, HOTPATCH_PROXY_VALID, "hotpatch.proxyValidate", "!hotpatch_validate", BOTH, "Hotpatch",                    \
      handleHotpatchProxyValidate, CMD_NONE)                                                                           \
    X(9012, HOTPATCH_PRESET_SAVE, "hotpatch.presetSave", "!hotpatch_save", BOTH, "Hotpatch", handleHotpatchPresetSave, \
      CMD_NONE)                                                                                                        \
    X(9013, HOTPATCH_PRESET_LOAD, "hotpatch.presetLoad", "!hotpatch_load", BOTH, "Hotpatch", handleHotpatchPresetLoad, \
      CMD_NONE)                                                                                                        \
    X(9014, HOTPATCH_EVENT_LOG, "hotpatch.eventLog", "!hotpatch_log", BOTH, "Hotpatch", handleHotpatchEventLog,        \
      CMD_NONE)                                                                                                        \
    X(9015, HOTPATCH_RESET_STATS, "hotpatch.resetStats", "!hotpatch_reset", BOTH, "Hotpatch",                          \
      handleHotpatchResetStats, CMD_CONFIRM)                                                                           \
    X(9016, HOTPATCH_TOGGLE_ALL, "hotpatch.toggleAll", "!hotpatch_toggle", BOTH, "Hotpatch", handleHotpatchToggleAll,  \
      CMD_NONE)                                                                                                        \
    X(9017, HOTPATCH_PROXY_STATS, "hotpatch.proxyStats", "!hotpatch_pstats", BOTH, "Hotpatch",                         \
      handleHotpatchProxyStats, CMD_NONE)                                                                              \
                                                                                                                       \
    /* ═══════════════════ MONACO/VIEW (9100-9105) ═══════════════════ */                                              \
    X(9100, MONACO_TOGGLE, "view.monacoToggle", "!monaco toggle", BOTH, "Monaco", handleMonacoToggle, CMD_NONE)        \
    X(9101, MONACO_DEVTOOLS, "view.monacoDevtools", "!monaco devtools", BOTH, "Monaco", handleMonacoDevtools,          \
      CMD_NONE)                                                                                                        \
    ...
    X(9104, MONACO_ZOOM_OUT, "view.monacoZoomOut", "!monaco zoomout", GUI_ONLY, "Monaco", handleMonacoZoomOut,         \
      CMD_NONE)                                                                                                        \
    X(9105, MONACO_SYNC_THEME, "view.monacoSyncTheme", "!monaco sync", BOTH, "Monaco", handleMonacoSyncTheme,          \
      CMD_NONE)                                                                                                        \
                                                                                                                       \
    ...
    X(9205, LSPSRV_PUBLISH_DIAG, "lspServer.publishDiag", "!lspsrv diag", BOTH, "LSPServer", handleLspSrvPublishDiag,  \
      CMD_NONE)                                                                                                        \
    X(9206, LSPSRV_CONFIG, "lspServer.config", "!lspsrv config", BOTH, "LSPServer", handleLspSrvConfig, CMD_NONE)      \
    X(9207, LSPSRV_EXPORT_SYMS, "lspServer.exportSyms", "!lspsrv export", BOTH, "LSPServer",                           \
      handleLspSrvExportSymbols, CMD_NONE)                                                                             \
    X(9208, LSPSRV_LAUNCH_STDIO, "lspServer.launchStdio", "!lspsrv stdio", BOTH, "LSPServer", handleLspSrvLaunchStdio, \
      CMD_ASYNC)                                                                                                       \
                                                                                                                       \
    ...
    X(9302, EDITOR_MONACOCORE, "editor.monacocore", "!editor monaco", BOTH, "Editor", handleEditorMonacoCore,          \
      CMD_NONE)                                                                                                        \
    ...
    X(9505, AUDIT_EXPORT_REPORT, "audit.exportReport", "!audit export", BOTH, "Audit", handleAuditExportReport,        \
      CMD_NONE)                                                                                                        \
    ...
    X(9823, QW_ALERT_RESOURCE, "qw.alertResourceStatus", "!qw resources", BOTH, "QW", handleQwAlertResourceStatus,     \
      CMD_NONE)                                                                                                        \
    X(9830, QW_SLO_DASHBOARD, "qw.sloDashboard", "!qw slo", BOTH, "QW", handleQwSloDashboard, CMD_NONE)                \
                                                                                                                       \
    /* ═══════════════════ TELEMETRY (9900-9905) ═══════════════════ */                                                \
    X(9900, TELEMETRY_TOGGLE, "telemetry.toggle", "!telemetry toggle", BOTH, "Telemetry", handleTelemetryToggle,       \
      CMD_NONE)                                                                                                        \
    X(9901, TELEMETRY_EXPORT_JSON, "telemetry.exportJson", "!telemetry json", BOTH, "Telemetry",                       \
      handleTelemetryExportJson, CMD_NONE)                                                                             \
    X(9902, TELEMETRY_EXPORT_CSV, "telemetry.exportCsv", "!telemetry csv", BOTH, "Telemetry",                          \
      handleTelemetryExportCsv, CMD_NONE)                                                                              \
    X(9903, TELEMETRY_DASHBOARD, "telemetry.dashboard", "!telemetry show", BOTH, "Telemetry",                          \
      handleTelemetryDashboard, CMD_NONE)                                                                              \
    X(9904, TELEMETRY_CLEAR, "telemetry.clear", "!telemetry clear", BOTH, "Telemetry", handleTelemetryClear,           \
      CMD_CONFIRM)                                                                                                     \
    X(9905, TELEMETRY_SNAPSHOT, "telemetry.snapshot", "!telemetry snap", BOTH, "Telemetry", handleTelemetrySnapshot,   \
      CMD_NONE)                                                                                                        \
                                                                                                                       \
    ...
    X(2011, EDIT_PASTE_LEGACY, "edit.paste.legacy", "!paste_alt", GUI_ONLY, "Edit", handleEditPaste,                   \
      CMD_REQUIRES_FILE)                                                                                               \
    X(3001, TERMINAL_PS_LEGACY, "terminal.ps.legacy", "!terminal_ps", GUI_ONLY, "Terminal", handleTerminalSplitH,      \
      CMD_NONE)                                                                                                        \
    X(3002, TERMINAL_CMD_LEGACY, "terminal.cmd.legacy", "!terminal_cmd", GUI_ONLY, "Terminal", handleTerminalSplitH,   \
      CMD_NONE)                                                                                                        \
    X(3003, TERMINAL_STOP_LEGACY, "terminal.stop.legacy", "!terminal_stop", GUI_ONLY, "Terminal", handleTerminalKill,  \
      CMD_NONE)                                                                                                        \
    X(3004, TERMINAL_SPLITH_LEGACY, "terminal.splitH.legacy", "!terminal_sh", GUI_ONLY, "Terminal",                    \
      handleTerminalSplitH, CMD_NONE)                                                                                  \
    X(3005, TERMINAL_SPLITV_LEGACY, "terminal.splitV.legacy", "!terminal_sv", GUI_ONLY, "Terminal",                    \
      handleTerminalSplitV, CMD_NONE)                                                                                  \
    X(3006, TERMINAL_CLEARALL_LEG, "terminal.clearAll.legacy", "!terminal_clearall", GUI_ONLY, "Terminal",             \
      handleTerminalKill, CMD_NONE)                                                                                    \
    ...
    X(3013, TOOLS_ANALYZE_SCRIPT, "tools.analyzeScript", "!analyze_script", BOTH, "Tools", handleAnalyze,              \
      CMD_REQUIRES_FILE)                                                                                               \
    X(3050, MODULES_REFRESH, "modules.refresh", "!modules_refresh", BOTH, "Modules", handleViewModuleBrowser,          \
      CMD_NONE)                                                                                                        \
    ...
    X(0, CLI_HOTPATCH_APPLY, "cli.hotpatchApply", "!hotpatch_apply", CLI_ONLY, "CLI", handleHotpatchApply,             \
      CMD_ASM_HOTPATH)                                                                                                 \
    X(0, CLI_HOTPATCH_CREATE, "cli.hotpatchCreate", "!hotpatch_create", CLI_ONLY, "CLI", handleHotpatchCreate,         \
      CMD_NONE)                                                                                                        \
    ...
    X(0, CLI_SETTINGS_EXPORT, "cli.settingsExport", "!settings_export", CLI_ONLY, "CLI", handleSettingsExport,         \
      CMD_NONE)                                                                                                        \
    X(0, CLI_SETTINGS_IMPORT, "cli.settingsImport", "!settings_import", CLI_ONLY, "CLI", handleSettingsImport,         \
      CMD_NONE)                                                                                                        \
    ...
    X(208, EDIT_SELECTALL_IDE, "edit.selectAll.ide", "!selectall_ide", GUI_ONLY, "Edit", handleEditSelectAll,          \
      CMD_REQUIRES_FILE)                                                                                               \
    X(209, EDIT_MULTICURSOR_ADD, "edit.multicursorAdd", "!multicursor_add", BOTH, "Edit", handleEditMulticursorAdd,    \
      CMD_REQUIRES_FILE | CMD_REQUIRES_CARET)                                                                          \
    X(210, EDIT_MULTICURSOR_REM, "edit.multicursorRemove", "!multicursor_rm", BOTH, "Edit",                            \
      handleEditMulticursorRemove, CMD_REQUIRES_FILE)                                                                  \
    ...
    X(301, VIEW_TOGGLE_SIDEBAR, "view.toggleSidebar", "!toggle_sidebar", BOTH, "View", handleViewToggleSidebar,        \
      CMD_NONE)                                                                                                        \
    X(302, VIEW_TOGGLE_TERMINAL, "view.toggleTerminal", "!toggle_terminal", BOTH, "View", handleViewToggleTerminal,    \
      CMD_NONE)                                                                                                        \
    X(303, VIEW_TOGGLE_OUTPUT, "view.toggleOutput", "!toggle_output", BOTH, "View", handleViewToggleOutput, CMD_NONE)  \
    X(304, VIEW_TOGGLE_FULLSCREEN, "view.toggleFullscreen", "!fullscreen", BOTH, "View", handleViewToggleFullscreen,   \
      CMD_NONE)                                                                                                        \
    ...
    X(404, AI_REFACTOR, "ai.refactor", "!ai_refactor", BOTH, "AIMode", handleAIRefactor,                               \
      CMD_REQUIRES_SELECT | CMD_ASYNC)                                                                                 \
    X(405, AI_GENERATE_TESTS, "ai.generateTests", "!ai_tests", BOTH, "AIMode", handleAIGenerateTests,                  \
      CMD_REQUIRES_FILE | CMD_ASYNC)                                                                                   \
    X(406, AI_GENERATE_DOCS, "ai.generateDocs", "!ai_docs", BOTH, "AIMode", handleAIGenerateDocs,                      \
      CMD_REQUIRES_FILE | CMD_ASYNC)                                                                                   \
    ...
    X(8001, DECOMP_RENAME_VAR, "decomp.renameVar", "!decomp_rename_var", BOTH, "ReverseEng", handleDecompRenameVar,    \
      CMD_REQUIRES_FILE | CMD_REQUIRES_CARET)                                                                          \
    X(8002, DECOMP_GOTO_DEF, "decomp.gotoDef", "!decomp_goto", BOTH, "ReverseEng", handleDecompGotoDef,                \
      CMD_REQUIRES_FILE | CMD_REQUIRES_CARET)                                                                          \
    X(8003, DECOMP_FIND_REFS, "decomp.findRefs", "!decomp_refs", BOTH, "ReverseEng", handleDecompFindRefs,             \
      CMD_REQUIRES_FILE | CMD_REQUIRES_CARET)                                                                          \
    X(8004, DECOMP_COPY_LINE, "decomp.copyLine", "!decomp_copyline", BOTH, "ReverseEng", handleDecompCopyLine,         \
      CMD_REQUIRES_FILE | CMD_REQUIRES_CARET)                                                                          \
    X(8005, DECOMP_COPY_ALL, "decomp.copyAll", "!decomp_copyall", BOTH, "ReverseEng", handleDecompCopyAll,             \
      CMD_REQUIRES_FILE)                                                                                               \
    X(8006, DECOMP_GOTO_ADDR, "decomp.gotoAddr", "!decomp_addr", BOTH, "ReverseEng", handleDecompGotoAddr,             \
      CMD_REQUIRES_FILE)                                                                                               \
                                                                                                                       \
    ...
    X(10002, VSCEXT_LIST_CMDS, "vscext.listCommands", "!vscext commands", BOTH, "Plugin", handleVscExtListCommands,    \
      CMD_NONE)                                                                                                        \
    X(10003, VSCEXT_LIST_PROVIDERS, "vscext.listProviders", "!vscext providers", BOTH, "Plugin",                       \
      handleVscExtListProviders, CMD_NONE)                                                                             \
    X(10004, VSCEXT_DIAGNOSTICS, "vscext.diagnostics", "!vscext diag", BOTH, "Plugin", handleVscExtDiagnostics,        \
      CMD_NONE)                                                                                                        \
    ...
    X(10007, VSCEXT_LOAD_NATIVE, "vscext.loadNative", "!vscext native", BOTH, "Plugin", handleVscExtLoadNative,        \
      CMD_NONE)                                                                                                        \
    X(10008, VSCEXT_DEACTIVATE_ALL, "vscext.deactivateAll", "!vscext deactivate", BOTH, "Plugin",                      \
      handleVscExtDeactivateAll, CMD_CONFIRM)                                                                          \
    X(10009, VSCEXT_EXPORT_CONFIG, "vscext.exportConfig", "!vscext export", BOTH, "Plugin", handleVscExtExportConfig,  \
      CMD_NONE)                                                                                                        \
                                                                                                                       \
    ...
    X(10619, UNREAL_INIT, "unreal.init", "!unreal_init", BOTH, "GameEngine", handleUnrealInit, CMD_ASYNC)              \
    X(10620, UNREAL_ATTACH, "unreal.attach", "!unreal_attach", BOTH, "GameEngine", handleUnrealAttach, CMD_ASYNC)      \
    X(10621, UNITY_INIT, "unity.init", "!unity_init", BOTH, "GameEngine", handleUnityInit, CMD_ASYNC)                  \
    X(10622, UNITY_ATTACH, "unity.attach", "!unity_attach", BOTH, "GameEngine", handleUnityAttach, CMD_ASYNC)          \
                                                                                                                       \
    /* ═══════════════════ REVERSE ENGINEERING (8100-8150) ═══════════════════ */                                      \
    X(8100, REVENG_DISASSEMBLE, "reveng.disassemble", "!reveng_dis", BOTH, "ReverseEng", handleRevengDisassemble,      \
      CMD_REQUIRES_FILE)                                                                                               \
    X(8101, REVENG_DECOMPILE, "reveng.decompile", "!reveng_decomp", BOTH, "ReverseEng", handleRevengDecompile,         \
      CMD_REQUIRES_FILE)                                                                                               \
    X(8102, REVENG_FIND_VULN, "reveng.findVulns", "!reveng_vuln", BOTH, "ReverseEng", handleRevengFindVulnerabilities, \
      CMD_REQUIRES_FILE | CMD_ASYNC)                                                                                   \
                                                                                                                       \
    ...
    X(11201, GOVERNOR_POWER, "governor.setPowerLevel", "!governor_power", BOTH, "Governor",                            \
      handleGovernorSetPowerLevel, CMD_NONE)                                                                           \
                                                                                                                       \
    /* ═══════════════════ MARKETPLACE & EXTENSIONS (11300-11350) ═══════════════════ */                               \
    X(11300, MARKETPLACE_LIST, "marketplace.list", "!marketplace_list", BOTH, "Marketplace", handleMarketplaceList,    \
      CMD_NONE)                                                                                                        \
    X(11301, MARKETPLACE_INSTALL, "marketplace.install", "!marketplace_install", BOTH, "Marketplace",                  \
      handleMarketplaceInstall, CMD_ASYNC)                                                                             \
                                                                                                                       \
    /* ═══════════════════ EMBEDDINGS & VECTORS (11400-11450) ═══════════════════ */                                   \
    X(11400, EMBEDDING_ENCODE, "embedding.encode", "!embedding_encode", BOTH, "Embedding", handleEmbeddingEncode,      \
      CMD_NONE)                                                                                                        \
                                                                                                                       \
    /* ═══════════════════ VISION & IMAGE ANALYSIS (11500-11550) ═══════════════════ */                                \
    X(11500, VISION_ANALYZE, "vision.analyze", "!vision_analyze", BOTH, "Vision", handleVisionAnalyzeImage,            \
      CMD_REQUIRES_FILE)                                                                                               \
                                                                                                                       \
    /* ═══════════════════ PROMPT ENGINE (11600-11650) ═══════════════════ */                                          \
    X(11600, PROMPT_CLASSIFY, "prompt.classify", "!prompt_classify", BOTH, "Prompt", handlePromptClassifyContext,      \
      CMD_NONE)                                                                                                        \
                                                                                                                       \
    /* ═══════════════════ TIER 1: CRITICAL COSMETICS (12000-12099) ═══════════════════ */                             \
    X(12000, T1_SMOOTH_SCROLL, "tier1.smoothScroll", "!smooth_scroll", BOTH, "Cosmetic",                               \
      handleTier1SmoothScrollToggle, CMD_NONE)                                                                         \
    X(12001, T1_MINIMAP_ENHANCED, "tier1.minimapEnhanced", "!minimap_enhanced", BOTH, "Cosmetic",                      \
      handleTier1MinimapEnhanced, CMD_NONE)                                                                            \
    X(12020, T1_BREADCRUMBS, "tier1.breadcrumbs", "!breadcrumbs", BOTH, "Cosmetic", handleTier1BreadcrumbsToggle,      \
      CMD_NONE)                                                                                                        \
    X(12030, T1_FUZZY_PALETTE, "tier1.fuzzyPalette", "!fuzzy", BOTH, "Cosmetic", handleTier1FuzzyPalette, CMD_NONE)    \
    X(12040, T1_SETTINGS_GUI, "tier1.settingsGUI", "!settings_gui", BOTH, "Cosmetic", handleTier1SettingsGUI,          \
      CMD_NONE)                                                                                                        \
    ...
    X(12081, T1_SPLIT_HORIZ, "tier1.splitHorizontal", "!split_h", BOTH, "Cosmetic", handleTier1SplitHorizontal,        \
      CMD_NONE)                                                                                                        \
    ...
    X(12084, T1_SPLIT_FOCUS_NEXT, "tier1.splitFocusNext", "!split_next", BOTH, "Cosmetic", handleTier1SplitFocusNext,  \
      CMD_NONE)                                                                                                        \
    X(12090, T1_AUTO_UPDATE, "tier1.autoUpdate", "!auto_update", BOTH, "Cosmetic", handleTier1AutoUpdateCheck,         \
      CMD_ASYNC)                                                                                                       \
    X(12091, T1_UPDATE_DISMISS, "tier1.updateDismiss", "!update_dismiss", BOTH, "Cosmetic", handleTier1UpdateDismiss,  \
      CMD_NONE)                                                                                                        \
                                                                                                                       \
    /* ═══════════════════ TRANSCENDENCE SYSTEMS (43000-43099) ═══════════════════ */                                  \
    X(43000, CURSOR_PARITY_BRIDGE, "transcendence.cursorParity", "!cursor_parity", BOTH, "Transcendence",              \
      HandleCursorParityBridge, CMD_NONE)                                                                              \
    X(43001, OMEGA_ORCHESTRATOR, "transcendence.omegaOrch", "!omega_orch", BOTH, "Transcendence",                      \
      HandleOmegaOrchestrator, CMD_NONE)                                                                               \
    X(43002, MESH_BRAIN, "transcendence.meshBrain", "!mesh_brain", BOTH, "Transcendence", HandleMeshBrain, CMD_NONE)   \
    X(43003, SPECIATOR_ENGINE, "transcendence.speciator", "!speciator", BOTH, "Transcendence", HandleSpeciatorEngine,  \
      CMD_NONE)                                                                                                        \
    X(43004, NEURAL_BRIDGE, "transcendence.neuralBridge", "!neural_bridge", BOTH, "Transcendence", HandleNeuralBridge, \
      CMD_NONE)                                                                                                        \
    X(43005, SELF_HOST_ENGINE, "transcendence.selfHost", "!self_host", BOTH, "Transcendence", HandleSelfHostEngine,    \
      CMD_NONE)                                                                                                        \
    X(43006, HARDWARE_SYNTHESIZER, "transcendence.hwSynth", "!hw_synth", BOTH, "Transcendence",                        \
      HandleHardwareSynthesizer, CMD_NONE)                                                                             \
    X(43007, TRANSCENDENCE_COORD, "transcendence.coordinator", "!trans_coord", BOTH, "Transcendence",                  \
      HandleTranscendenceCoordinator, CMD_NONE)                                                                        \
    X(43008, VULKAN_RENDERER, "transcendence.vulkanRenderer", "!vulkan_rend", BOTH, "Transcendence",                   \
      HandleVulkanRenderer, CMD_NONE)                                                                                  \
    X(43009, OS_EXPLORER_INTERCEPT, "transcendence.osExplorer", "!os_explorer", BOTH, "Transcendence",                 \
      HandleOSExplorerInterceptor, CMD_NONE)                                                                           \
    X(43010, MCP_HOOKS, "transcendence.mcpHooks", "!mcp_hooks", BOTH, "Transcendence", HandleMCPHooks, CMD_NONE)       \
    X(43011, IOCP_FILE_WATCHER, "transcendence.iocpWatcher", "!iocp_watcher", BOTH, "Transcendence",                   \
      HandleIOCPFileWatcher, CMD_NONE)                                                                                 \
    X(43012, IDE_AUTO_HEALER, "transcendence.autoHealer", "!auto_healer", BOTH, "Transcendence",                       \
      HandleIDEDiagnosticAutoHealer, CMD_NONE)                                                                         \
    X(43013, CONSENT_PROMPT, "transcendence.consentPrompt", "!consent", BOTH, "Transcendence", HandleConsentPrompt,    \
      CMD_NONE)                                                                                                        \
                                                                                                                       \
...
#define EXPAND_CMD_ENUM(id, sym, name, cli, exp, cat, handler, flags) CMD_##sym = id,
...
#define EXPAND_CMD_DECL(id, sym, name, cli, exp, cat, handler, flags) CommandResult handler(const CommandContext& ctx);

COMMAND_TABLE(EXPAND_CMD_DECL)
#undef EXPAND_CMD_DECL

inline const CmdDescriptor g_commandRegistry[] = {COMMAND_TABLE(EXPAND_CMD_DESC)};
