...
if (loadEnginesBtn) {
  ...
  console.warn('⚠️ loadEngines button not found in DOM');
}

// Bot Generators with executable output
const ircBotGen = document.getElementById('ircBotGen');
if (ircBotGen) {
  ircBotGen.addEventListener('click', async () => {
    try {
...
const httpBotGen = document.getElementById('httpBotGen');
if (httpBotGen) {
  httpBotGen.addEventListener('click', async () => {
    try {
...
const tcpBotGen = document.getElementById('tcpBotGen');
if (tcpBotGen) {
...
const udpBotGen = document.getElementById('udpBotGen');
if (udpBotGen) {
